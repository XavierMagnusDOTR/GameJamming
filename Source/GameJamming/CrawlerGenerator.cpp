...
// Sets default values
void ACrawlerGenerator::Generate()
{
	if (bRunPrims)
	{
...
void ACrawlerGenerator::VCrawler()
{
...
void ACrawlerGenerator::HCrawler()
{
	bool Done = false;
...
void ACrawlerGenerator::CenterOutCrawler()
{
	bool Done = false;
	//int x = MapWidth / 2; // For half map
	int x = MapWidth / 2;
...
void ACrawlerGenerator::RunPrims()
{
	bool Done = false;
